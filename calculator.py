...
if __name__ == "__main__":
    window = Tk()
    window.title("Soyuz Space Calculator")

    expression_field_value = StringVar()
    expression_field = Entry(window, width=50, textvariable=expression_field_value)
    ...
    equal_button.grid(row=4, column=2, sticky="ew")
